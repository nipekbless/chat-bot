     ...
     try{
      switch(msg){
        case "1":
          ...
          .join("\n");
          customer.cart = []
          await botResponse(`Available snacks and their respective tags: <br>${menuList} Please select one by typing its corresponding tag.`);
          break; 
        ...
        await botResponse(`<b>${item1Requested.name}</b> has been added to cart. <br> Type <b>1</b> to place more orders.<br> Type <b>97</b> to view cart. <br> Type <b>99</b> to checkout. <br> type<b>98</b> to view checked out order(s).`)
        break;
        ...
        await botResponse(`<b>${item2Requested.name}</b> has been added to cart. <br> Type <b>1</b> to place more orders.<br> Type <b>97</b> to view cart. <br> Type <b>99</b> to checkout. <br> type<b>98</b> to view checked out order(s).`)
        break;
        ...
        await botResponse(`<b>${item3Requested.name}</b> has been added to cart. <br> Type <b>1</b> to place more orders.<br> Type <b>97</b> to view cart. <br> Type <b>99</b> to checkout. <br> type<b>98</b> to view checked out order(s).`)
        break;
        ...
        await botResponse(`<b>${item4Requested.name}</b> has been added to cart. <br> Type <b>1</b> to place more orders.<br> Type <b>97</b> to view cart. <br> Type <b>99</b> to checkout. <br> type<b>98</b> to view checked out order(s).`)
        break;
      //  checkout
        case"99":
        if(customer.cart.length === 0){
          await botResponse ("No order in the cart to check out. Please type <b>1</b> to place order ")
        } else{
          customer.cart.map((prod)=>orderHistory.push(prod));
          await botResponse("Order placed succesfully! <br> Type <b>1</b> to place more order(s) <br> Type <b>98</b> to view cheched out orders(s). ")
          customer.cart = []
        }
        break;
    //  to view cart
        ...
        if(customer.cart.length=== 0 || customer.cart.length===null){
          await botResponse("No item in the cart! Please type <b>1</b> to place order")
        } else {
        ...
        case "98":
          if (orderHistory.length === 0) {
            await botResponse("No previous checked out orders. Please type <b>1</b> to place order.");
          }
        ...
        case "0":
          if (customer.cart.length === 0) {
            await botResponse("You have no plced order to cancel. Please type <b>1</b> to place orders.");
          }
          else if( customer.cart.length === null){
            ...
            customer.cart = [];
            await botResponse("Order cancelled. type <b>1</b> to view list of options");
          }
          break;
        default:
          await botResponse("Invalid input <br>Please input <b>1</b> to view list of options");
